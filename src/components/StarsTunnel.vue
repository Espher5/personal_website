...
export default defineComponent ({
    ...
    mounted() {
        ...
        (this.$refs.container as any).appendChild(renderer.domElement);
        ...
        const animate = () => {
            ...
            if (camera.position.z <= tunnelDepth  - (particleBatchDepth * 3/4)) {
                ...
                // eslint-disable-next-line
                let material: any = particles[firstparticlesIndex].material;
                material.transparent = true;
                material.opacity = 0;
                scene.add(particles[firstparticlesIndex]);
                TweenMax.to(material, 10, { opacity: 1 });
        ...
        function createParticles(offset: THREE.Vector3) {
        ...
        function createPositions(offset: THREE.Vector3) {
